...
function click() {
  ...
  if (selectedOption == 1) {
    ...
    para3.textContent = "Octal : " + decimalToOctal(decimal, points);
    para4.textContent = "Hexa Decimal : " + decimalToHexa(decimal, points);
  } else if (selectedOption == 2) {
    const decimal = octalToDecimal(input, input.length);
    para1.textContent = "Decimal : " + decimal;
    para2.textContent = "Binary : " + decimalToBinary(decimal, points);
